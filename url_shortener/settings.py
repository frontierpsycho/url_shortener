...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/nameless/programs/url_shortener/sqlite.db',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = '-iv1r^tdvd3kuk2t99e*tdw3v7ky#anbb$@x=2r$wltcdrt_d!'
